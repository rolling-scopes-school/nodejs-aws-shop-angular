...
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([
  ...
  \**************************/
      /***/ (
        ...
        /* harmony import */ var zone_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! zone.js */ 4946);
  ...
  \***********************************************/
      /***/ () => {
        ...
        (function (global) {
          ...
          class _ZoneDelegate {
            constructor(zone, parentDelegate, zoneSpec) {
              ...
              this._interceptZS =
                zoneSpec &&
                (zoneSpec.onIntercept ? zoneSpec : parentDelegate._interceptZS);
              this._interceptDlgt =
                zoneSpec &&
        ...
        const wrapFn = function (event) {
          ...
          if (!eventNameSymbol) {
            eventNameSymbol = zoneSymbolEventNames$1[event.type] = zoneSymbol(
        ...
        function patchProperty(obj, prop, prototype) {
          ...
          if (!eventNameSymbol) {
            eventNameSymbol = zoneSymbolEventNames$1[eventName] = zoneSymbol(
        ...
        function patchMethod(target, name, patchFn) {
          ...
          if (
            proto &&
            (!(delegate = proto[delegateName]) ||
              !proto.hasOwnProperty(delegateName))
          ) {
        ...
        Zone.__load_patch("ZoneAwarePromise", (global, Zone, api) => {
          ...
          class ZoneAwarePromise {
            ...
            then(onFulfilled, onRejected) {
              ...
              let C =
                (_a = this.constructor) === null || _a === void 0
                  ? void 0
                  : _a[Symbol.species];
        ...
        Zone.__load_patch("toString", (global) => {
          ...
          newFunctionToString[ORIGINAL_DELEGATE_SYMBOL] =
        ...
        function patchEventTarget(_global, api, apis, patchOptions) {
          ...
          function globalCallback(context, event, isCapture) {
            ...
            const tasks =
              target[
                zoneSymbolEventNames[event.type][
                  isCapture ? TRUE_STR : FALSE_STR
                ]
              ];
            if (tasks) {
              const errors = [];
          ...
          function patchEventTargetMethods(obj, patchOptions) {
            ...
            const taskData = {};
            const nativeAddEventListener = (proto[zoneSymbolAddEventListener] =
            ...
            const makeAddListener = function (
              ...
              return function () {
                ...
                if (
                  validateHandler &&
                  !validateHandler(nativeListener, delegate, target, arguments)
                ) {
                  return;
                }
                const passive =
        ...
        Zone.__load_patch("EventTarget", (global, Zone, api) => {
          ...
          if (
            ...
            api.patchEventTarget(global, api, [
              XMLHttpRequestEventTarget.prototype,
            ]);
          }
        });
